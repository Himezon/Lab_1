...
public class lab_1 {
    ...
    public static void main(String[] args) {
        ...
        for (double[] i : thirdArray(a, x)){
            for (double j : i){
                System.out.printf("%.2f %-20", j); //Вылетают NaN-ы в основном из-за того, что местами приходится возводить отрицательное число в дробную степень. Такая уж формула дана
            }
            System.out.println();
        }
    }
