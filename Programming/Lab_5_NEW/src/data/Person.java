...
public class Person implements Comparable <Person> {
     ...
     */
    public static long generateUniqueId (final TreeMap<Long, Person> treeMap) {
        long id;
        if (!treeMap.isEmpty())
     ...
     */
    public static boolean checkUniqueId (final TreeMap<Long, Person> treeMap, final long id) {
     ...
     */
    public void setCreationDate (final java.time.ZonedDateTime creationDate) throws IncorrectValueException {
